...
public class MyRecyclerViewAdapterForAllSongFragment extends RecyclerView.Adapter<MyRecyclerViewAdapterForAllSongFragment.MyViewHolder> {
    ...
    private String textStyleValue,value;

    public MyRecyclerViewAdapterForAllSongFragment(AllsongFragment allsongFragment,HomeActivity homeActivity, ArrayList<CustomFile> allFiles)
    {
        this.allsongFragment=allsongFragment;
        this.allFiles=allFiles;
        mediaMetadataRetriever=new MediaMetadataRetriever();
        sharedPraferenceForTextStyle=new SharedPraferenceForTextStyle(homeActivity);
    ...
    @NonNull
    @Override
    public MyRecyclerViewAdapterForAllSongFragment.MyViewHolder onCreateViewHolder(@NonNull final ViewGroup viewGroup, int i) {
        ...
        MyRecyclerViewAdapterForAllSongFragment.MyViewHolder myViewHolder=new MyRecyclerViewAdapterForAllSongFragment.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull MyRecyclerViewAdapterForAllSongFragment.MyViewHolder myViewHolder, int i)
    {
